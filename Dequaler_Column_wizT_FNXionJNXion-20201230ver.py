#Dequaler_Column_wizT_FNXionJNXion-20201230ver.py
...
#数式の入った列の範囲をR1C1表記で指定する。→各セルの冒頭の一文字を別の文字に替える(数式なので冒頭のイコールを除いて、計算処理を無効化する)。
...
# 念の為、別名で保存しておく
book1.save(XLSX0 + '_FNXion_wizT_DequaledCol_JNXion.xlsx')
 
    
# 読み込んでいたExcelファイルを閉じる
book1.close()

# “FNXionJNXion (Dequaler_Column) in Python 3.8” produced by K.masamix “KIXAN” as the SHYNAMITES/La CHENAMITOJ, 2020/12/30.
