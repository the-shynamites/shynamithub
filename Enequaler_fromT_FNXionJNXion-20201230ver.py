#Enequaler_fromT_FNXionJNXion-20201230ver.py
...
# 念の為、別名で保存しておく
book1.save(XLSX0 + '_JNXion_fromT_Enequaled_FNXion.xlsx')
 
    
# 読み込んでいたExcelファイルを閉じる
book1.close()

# “FNXionJNXion (Enequaler) in Python 3.8” produced by K.masamix “KIXAN” as the SHYNAMITES/La CHENAMITOJ, 2020/12/30.
