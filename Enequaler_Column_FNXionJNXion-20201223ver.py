...
# 念の為、別名で保存しておく
book1.save(XLSX0 + '_JNXion_EnequaledColumn_FNXion.xlsx')
 
    
# 読み込んでいたExcelファイルを閉じる
book1.close()

# “FNXionJNXion (Enequaler_Column) in Python 3.8” produced by K.masamix “KIXAN” as the SHYNAMITES/La CHENAMITOJ, 2020/12/23.
